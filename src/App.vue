<template>
  ...
  <main>
    <section id="home" class="hero-section flex-align flex-wrap">
      <div v-intersect class="hero-text left-target">
        <h1 class="hero-greeting">
          Hello I'm <br />
          <span class="hero-name linear-gradient-text typewriter"
            >Coleen Garcia</span
          >
        </h1>
      ...
      <div class="hero-image-container">
        <img
          v-intersect
          src="@/assets/images/coleen-image.png"
          alt="my picture"
          class="hero-image right-target"
          draggable="false"
        />
      </div>
    </section>
    ...
    <div class="wave-container">
      ...
      >
        <path
          d="M0,160L48,181.3C96,203,192,245,288,224C384,203,480,117,576,85.3C672,53,768,75,864,106.7C960,139,1056,181,1152,170.7C1248,160,1344,96,1392,64L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
          fill-opacity="1"
          fill="#A04747"
        />
      </svg>
    ...
    <section id="about" class="about-section bg-gradient">
      ...
      <div class="about-content flex-align flex-wrap">
        ...
        <div v-intersect class="about-desc bottom-target">
          <h3 v-intersect class="txt-md italic bottom-target subtitle">
            A little bit about myself
          </h3>
          <div class="about-text">
            <p
              v-intersect
              class="text-light bottom-target about-p"
              v-for="(text, id) in aboutMe"
              :key="id"
            >
              {{ text }}
            </p>
          ...
          <div v-intersect class="about-education bs bottom-target">
            <p class="txt-lg bold linear-gradient-text">
    ...
    <section id="skills" class="skills-section">
      <h2 v-intersect class="section-title linear-gradient-text bottom-target">
        Technical Skills
      </h2>
      ...
      <div class="skills-content">
        <div
          v-intersect
          class="stack-container bs bottom-target"
          v-for="stack in Object.values(skills)"
        >
      ...
      <div class="timeline">
        ...
        >
          <div v-intersect class="timeline-content bs bottom-target">
            ...
            <h5 class="fs-1 fw-1">
              {{ internship.location }} | {{ internship.classification }}
            </h5>
    ...
    <section id="projects" class="projects-section bg-gradient">
      <h2 v-intersect class="section-title fc-inverse bottom-target">
        Projects
      </h2>
      <div class="card-container">
        ...
        >
          ...
          <div class="links">
            <a :href="project.link" target="_blank" class="live-demo"
              >Live Demo</a
            >
            <a :href="project.github" target="_blank" class="github-project"
              >GitHub</a
            >
          </div>
        </div>
    ...
    <section id="contact" class="socials-section">
      <h2 v-intersect class="section-title linear-gradient-text top-target">
        Let's Connect!
      </h2>
      ...
      <div class="social-content flex-align">
        <div v-intersect class="social-details left-target">
          <div class="social-item">
            ...
            <div class="stack-container bs item-content">
              <a
                href="https://www.linkedin.com/in/coleenagarcia"
                target="_blank"
                class="social-link"
              >
                <img
                  src="@/assets/images/socials-logo/linkedin.png"
                  alt="linkedin logo"
                />
              </a>
              <a
                href="https://github.com/kewlinnn"
                target="_blank"
                class="social-link"
              >
                <img
                  src="@/assets/images/socials-logo/github.png"
                  alt="github logo"
                />
              </a>
            </div>
        ...
        <div v-intersect class="contact-form right-target">
          ...
          <form @submit.prevent="submit" class="stack-container form-details">
            ...
            <p
              v-if="status"
              class="txt-center txt-small status"
              :class="status.type"
            >
              {{ status.message }}
            </p>

            <p class="txt-center txt-small">
              I value your privacy. The information you provide will only be
...
const projects = [
  ...
  // },
  {
    ...
    description:
      "An interactive Keno lottery game with classic and mini game modes.",
    image: "/images/project-thumbnails/keno-plus.jpg",
  ...
  },
  {
    ...
    description:
      "A dynamic Pokédex web app using PokeAPI to display and filter Pokémon data with server-side rendering.",
    image: "/images/project-thumbnails/dexhub.jpg",
  ...
  },
  {
    ...
    description:
      "A blogging platform that allows users to create, edit, and share their blog posts.",
    image: "/images/project-thumbnails/blogit.jpg",
